...
import (
	...
	"github.com/ethanol1310/go-forum/api/Password"
	"github.com/ethanol1310/go-forum/api/auth"
	"github.com/ethanol1310/go-forum/api/fileupload"
	"github.com/ethanol1310/go-forum/api/models"
	"github.com/ethanol1310/go-forum/api/utils/formaterror"
...
func (s *Server) UpdateUser(c *gin.Context) {
	...
	if requestBody["current_password"] != "" && requestBody["new_password"] != "" {
		...
		err = Password.VerifyPassword(formerUser.Password, requestBody["current_password"])
